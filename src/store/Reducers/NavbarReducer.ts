...
export type NavbarActionTypes =
    SetCompanyCategoriesActionType
    | SetProductCategoriesActionType
    | SetProductSubcategoriesActionType
    |
    SetSubcategoriesByCategoryActionType
    | SetCartProductListActionType
    | SetUserActionType
    | SetCountGoodsInCartActionType
    |
    SetIsSearchOpenActionType
    | SetHamburgerOpenActionType
    | SetIsCategoryHoveredActionType
    | SetIsCartOpenActionType
    |
    SetCurrentSelectedCategory
    | SetProductAllSubcategoriesType
