                    ...
                    <div key={index * 2} className={s.spoiler__container}>
                      <ul className={s.spoiler__ul}>
                        ...
                        {props.productSubcategoriesByCategory !== null
                          ...
                          <div onClick={(event) => {event.currentTarget.classList.toggle(s.opened)}} className={pageCategory.url == currentCategory.url ? `${s.spoiler__title_container} ${s.opened}` : s.spoiler__title_container}>
                            <span className={pageCategory.url == currentCategory.url ? `${s.spoiler__title} ${s.active}` : s.spoiler__title}>
                        ...
                        {props.productSubcategoriesByCategory
                          ...
                          && props.productSubcategoriesByCategory[index] !== undefined
                          && props.productSubcategoriesByCategory[index].length <= 1 &&
                          <a href={currentCategory.url} className={currentCategory.url == pageCategory.url ? `${s.spoiler__title} ${s.active}` : s.spoiler__title}>
                            {currentCategory.title}
                          </a>
                        }
                        {props.productSubcategoriesByCategory
                        ...
                        && props.productSubcategoriesByCategory[index].map((currentSubcategory, subIndex) => {
                          return (
                            <li key={subIndex * 3} className={pageSubcategory.url == currentSubcategory.url ? `${s.spoiler__li} ${s.active}` : s.spoiler__li}>
                ...
                <div className={s.filter__by_price_content}>
                  <div className={s.price__selector}>
                    <div className={s.price__from}>
                      <input
                        onChange={(event) => {handleSetPriceFrom(parseInt(event.currentTarget.value))}}
                    ...
                    <div className={s.price__to}>
                      <span>до</span>
                      <input
                        onChange={(event) => {handleSetPriceTo(parseInt(event.currentTarget.value))}}
                        value={priceToInput}
                        type="text"
                        placeholder="руб"/>
                    </div>
                  ...
                  <div className={s.btn__group}>
                    <button onClick={() => {handleResetPriceSearchParam()}} className={s.btn__reset}>
            ...
            <div className={s.catalog__products}>
              <div className={s.top__content}>
                ...
                <form className={s.chooser_sort}>
                  ...
                  <select className={s.chooser_sort__select} value={currentItemSort} onChange={(event) => {handleOnChangeOptionSort(event)}} name="sort" id="sort">
