                    ...
                    <div className={s.social__container}>
                      ...
                      <div>
                        <a href="" className={s.link__telegram}>
                          <svg id={s.telegram_social} width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M53 27C53 41.3594 41.3594 53 27 53C12.6406 53 1 41.3594 1 27C1 12.6406 12.6406 1 27 1C41.3594 1 53 12.6406 53 27Z" stroke="#22A6DC" strokeWidth="2"/>
                            <path id={s.telegram_title_social} d="M40.1414 15.5355L35.3215 39.8461C35.3215 39.8461 34.6465 41.5336 32.7902 40.7215L21.6633 32.1891L17.6133 30.2379L10.8 27.9492C10.8 27.9492 9.75584 27.5801 9.65037 26.768C9.5449 25.9559 10.8316 25.5234 10.8316 25.5234L37.916 14.9027C37.916 14.8922 40.1414 13.9113 40.1414 15.5355Z" fill="#22A6DC"/>
                            <path id={s.telegram_title_social} d="M20.7984 39.572C20.7984 39.572 20.4715 39.5403 20.0707 38.2642C19.6699 36.988 17.6133 30.238 17.6133 30.238L33.9715 19.8493C33.9715 19.8493 34.9207 19.2798 34.8785 19.8493C34.8785 19.8493 35.0473 19.9548 34.541 20.4188C34.0348 20.8935 21.6949 31.9888 21.6949 31.9888" fill="#22A6DC"/>
                            <path id={s.telegram_title_social} d="M25.9242 35.4586L21.5261 39.477C21.5261 39.477 21.1781 39.7406 20.809 39.5719L21.6527 32.1152" fill="#22A6DC"/>
                          </svg>
                        </a>
                      </div>
                    </div>
