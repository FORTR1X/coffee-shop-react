          ...
          <div className={s.container}>
            ...
            <div>
              {props.bestSellers.map((product, index) => {
                return (
                  <div onClick={() => {handleNavigateToProduct(product.id)}} className={s.product__container}>
                    <img
                    ...
                    <div className={s.product__btn_group}>
                      ...
                      <button type="button" onClick={() => {handleDeleteById(product.id)}}>
            ...
            <div className={s.input__container}>
              <input
                ...
                onChange={(event) => {handleSetIdInputValue(event.currentTarget.value)}}
                value={idInputValue}
              />
              <div
