  ...
  useEffect(() => {
    ...
    if (props.subcategories.length > 0 && subcategoryOptions.length == 0) {
      ...
      props.subcategories.map((subcategory) => {
        mappedSubcategoriesToOptionSubcategory.push({value: subcategory.id.toString(), option: subcategory.title})
      })
      ...
      <div className={s.content}>
        <div className={s.container}>
          ...
          <form className={s.chooser}>
            ...
            <select className={s.chooser__select} value={currentSubcategoryIdSelected} onChange={(event) => {handleOnChangeOptionSubcategory(event.currentTarget.value)}} name="subcategory" id="subcategory">
          ...
          <input
            ...
            onChange={(event) => {handleChooseImage(event.currentTarget)}}
          />
